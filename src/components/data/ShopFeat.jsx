  ...
  ProductReviews: [
    {
      rating: "⭐⭐⭐⭐☆ (4/5)",
      review:
        "Great quality fabric and perfect fit. Loved the color and design!",
      customer: "Areeba A. – July 2025",
    },
    {
      rating: "⭐⭐⭐⭐⭐ (5/5)",
      review: "Fast delivery and product is just like shown in pictures.",
  ...
  ShippingandReturn: [
    {
      ...
      content: `You may return most new, unopened items within 30 days of delivery for a full refund. We'll also pay the return shipping costs if the return is a result of our error (you received an incorrect or defective item, etc.).
...
If you need to return an item, simply login to your account, view the order using the 'Complete Orders' link under the My Account menu and click the Return Item(s) button. We'll notify you via e-mail of your refund once we've received and processed the returned item.`,
    ...
    {
      title: "Shipping",
      content: `We can ship to virtually any address in the world. Note that there are restrictions on some products, and some products cannot be shipped to international destinations.
